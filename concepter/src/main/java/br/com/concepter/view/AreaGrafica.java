...
public class AreaGrafica extends JInternalFrame {
    ...
    public void preencherGrade(Long valor){
        if(valor == 0){
            this.grafico.setGridEnabled(false);
            this.areaGrafico.setGridVisible(false);
            this.areaGrafico.setGridStyle(3);
        }else{
            this.grafico.setGridEnabled(true);
            this.areaGrafico.setGridVisible(true);
            this.areaGrafico.setGridStyle(3);
        }
